...
def load_dashboard_data():
    ...
    heatmap_df = pd.read_parquet('../data/05_dashboard/dash_state_heatmap.parquet')
    leaderboard_df = pd.read_parquet('../data/05_dashboard/dash_route_leaderboard.parquet')
    ship_mode_df = pd.read_parquet('../data/05_dashboard/dash_ship_mode.parquet')
